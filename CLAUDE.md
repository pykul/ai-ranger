...
AI Ranger is a passive network observability tool that detects AI provider usage via TLS SNI hostname extraction. No TLS interception, no MITM, no content inspection. See ARCHITECTURE.md for the agent pipeline and full-system layout.
