...
function BrandIcon({ bg, fill, d, className }: { bg: string; fill: string; d: string; className?: string }) {
  return (
    <svg width={S} height={S} viewBox="0 0 24 24" className={className} style={{ borderRadius: 3, background: bg }}>
      <g transform="scale(0.625) translate(4.5 4.5)">
        <path d={d} fill={fill} />
      </g>
    </svg>
  );
